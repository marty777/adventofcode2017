...
switch day {
	...
	case 15:
		Day15.run(inputPath: path)
	case 16:
		Day16.run(inputPath: path)
	case 17:
		Day17.run(inputPath: path)
	case 18:
		Day18.run(inputPath: path)
	case 19:
		Day19.run(inputPath: path)
	case 20:
		Day20.run(inputPath: path)
	case 21:
		Day21.run(inputPath: path)
	case 22:
